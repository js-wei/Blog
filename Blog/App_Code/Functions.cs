    ...
    public class Functions
    {
        ...
        public string HighLight(string content, string keywords, string color, string fontFamily, string fontSize, string isItalic = "true", string isBold = "true")
        {
            ...
            if (!string.IsNullOrEmpty(isItalic) || !string.IsNullOrEmpty(isBold) || !string.IsNullOrEmpty(fontSize))
            {
                ...
                {
                    if (this.IsNumber(isBold) || isBold.Equals("true") || isBold.Equals("bolder") || isBold.Equals("bold"))
                    {
        ...
        /// </summary>
        /// <returns></returns>
        public string Detault(string _str = "", string _default = "")
        {
            var _result = string.Empty;
            _result = string.IsNullOrEmpty(_str) ? (string.IsNullOrEmpty(_default) ? "管理员很懒，没有留下任何脚印" : _default) : _str;
            return _result;
        }
        /// <summary>
        ...
        public List<Dictionary<string, string>> ConvertToListDictionary<T>(List<T> obj)
        {
            ...
            {
                var _t = this.ConvertToDictionary<T>(_list);
